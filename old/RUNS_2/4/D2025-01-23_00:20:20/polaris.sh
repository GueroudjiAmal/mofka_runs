...
#          --tool=memcheck  --track-fds=yes --num-callers=50 \
mpiexec -n $sirt_ranks -ppn $sirt_ranks -d 16 --hosts $node_sirt ./build/bin/sirt_stream  --write-freq 4  \
--window-iter 1 --window-step 4 --window-length 4 -t 4 -c 1427 --protocol cxi --group-file mofka.json --batchsize 4 \
...
--protocol cxi --group_file mofka.json --batchsize 4 --nproc_sirt $sirt_ranks 1> den.out 2> den.err
