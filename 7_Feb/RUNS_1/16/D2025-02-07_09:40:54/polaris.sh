...
./data/tomo_00058_all_subsampled1p_s1079s1081.h5 --d_iteration 1  --batchsize 16  \
...
--normalize --beg_sinogram 1000 --num_sinograms 2 --num_columns 2560  --batchsize 16  \
...
--window-iter 1 --window-step 4 --window-length 4 -t 4 -c 1427 --protocol cxi --group-file mofka.json --batchsize 16  \
...
--protocol cxi --group_file mofka.json --batchsize 16 --nproc_sirt $sirt_ranks 1> den.out 2> den.err
